 ...
 * @author vvelsen
 */
public class FilterUnescape extends CellFilterBase implements CellFilterInterface {

	/**
	 * 
	 */
	public FilterUnescape(FilterConfig aConfig) {
		super(aConfig);
		setName("unescape");
	}
	...
	public String transform(String raw) {
		//return (FilterUnescape.unescape_perl_string(raw));
	...
	public static void main(String[] args) {
	  System.out.println ("Unescaped: " + StringEscapeUtils.unescapeHtml4 ("&lt;math&gt;"));	
	}
}
